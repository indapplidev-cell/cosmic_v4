...
def test_survive_timed_progress_endpoint(monkeypatch):
    monkeypatch.setattr("server.app.api.main.get_authenticated_user_id", lambda _request: 42)
    monkeypatch.setattr(
        "server.app.api.main.get_campaign_progress",
        lambda user_id: {
            "ok": True,
            "progress": {
                "user_id": user_id,
...
def test_survive_timed_level_result_endpoint(monkeypatch):
    monkeypatch.setattr("server.app.api.main.get_authenticated_user_id", lambda _request: 7)
    monkeypatch.setattr(
        "server.app.api.main.upsert_level_result",
...
def test_survive_timed_level_success_endpoint(monkeypatch):
    monkeypatch.setattr("server.app.api.main.get_authenticated_user_id", lambda _request: 9)
    monkeypatch.setattr(
        "server.app.api.main.record_survive_timed_level_success",
