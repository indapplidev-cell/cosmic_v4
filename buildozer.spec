...
requirements = python3==3.11.9,hostpython3==3.11.9,asyncgui==0.6.3,asynckivy==0.6.4,certifi==2026.1.4,charset-normalizer==3.4.4,docutils==0.22.4,filetype==1.2.0,idna==3.11,Kivy==2.3.1,Kivy-Garden==0.1.5,https://github.com/kivymd/KivyMD/archive/d668d8b2b3d9eb54517892f613ffe34d9914517a.zip,materialshapes==0.3,materialyoucolor==3.0.1,packaging==26.0,pillow==12.1.0,Pygments==2.19.2,pyjnius==1.6.1,requests==2.32.5,setuptools==80.10.2,urllib3==2.6.3,wheel==0.46.3
