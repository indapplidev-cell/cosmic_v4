...
RU: РЎРµСЂРІРёСЃ Р‘Р” РґР»СЏ РїРѕСЃС‚СЂРѕС‡РЅС‹С… СЂРµР·СѓР»СЊС‚Р°С‚РѕРІ survive_timed РїРѕ СѓСЂРѕРІРЅСЏРј.
"""
...
def _serialize_result(row: SurviveTimedUserLevelResult) -> dict:
    ...
    RU: РџСЂРµРѕР±СЂР°Р·РѕРІР°С‚СЊ ORM-СЃС‚СЂРѕРєСѓ СЂРµР·СѓР»СЊС‚Р°С‚Р° РІ СЃС‚Р°Р±РёР»СЊРЅС‹Р№ РѕР±С‹С‡РЅС‹Р№ СЃР»РѕРІР°СЂСЊ.
    """
    return {
...
def _get_or_create_result(session, user_id: int, level_number: int) -> SurviveTimedUserLevelResult:
    ...
    RU: Р’РµСЂРЅСѓС‚СЊ СЃСѓС‰РµСЃС‚РІСѓСЋС‰СѓСЋ СЃС‚СЂРѕРєСѓ СЂРµР·СѓР»СЊС‚Р°С‚Р° survive_timed РёР»Рё СЃРѕР·РґР°С‚СЊ РґРµС„РѕР»С‚РЅСѓСЋ.
    """
    row = session.scalar(
...
def _apply_level_result(
    ...
    *,
    ...
    RU: РџСЂРёРјРµРЅРёС‚СЊ РѕРґРЅРѕ РёР·РјРµРЅРµРЅРёРµ СЂРµР·СѓР»СЊС‚Р°С‚Р° survive_timed Рє СѓР¶Рµ Р·Р°РіСЂСѓР¶РµРЅРЅРѕР№ ORM-СЃС‚СЂРѕРєРµ.
    """
...
def get_level_result(user_id: int, level_number: int) -> dict:
    ...
    RU: Р’РµСЂРЅСѓС‚СЊ РѕРґРЅСѓ СЃС‚СЂРѕРєСѓ СЂРµР·СѓР»СЊС‚Р°С‚Р° survive_timed РґР»СЏ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ Рё СѓСЂРѕРІРЅСЏ.
    """
    try:
...
def get_all_level_results(user_id: int) -> dict:
    ...
    RU: Р’РµСЂРЅСѓС‚СЊ РІСЃРµ СЃС‚СЂРѕРєРё СЂРµР·СѓР»СЊС‚Р°С‚РѕРІ survive_timed РґР»СЏ Р°СѓС‚РµРЅС‚РёС„РёС†РёСЂРѕРІР°РЅРЅРѕРіРѕ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ.
    """
    try:
        user_id_value = int(user_id)
    except Exception:
...
def upsert_level_result(user_id: int, level_number: int, survival_ms: int, result: str) -> dict:
    ...
    RU: РћР±РЅРѕРІРёС‚СЊ РёР»Рё СЃРѕР·РґР°С‚СЊ СЂРµР·СѓР»СЊС‚Р°С‚ СѓСЂРѕРІРЅСЏ survive_timed СЃРѕ СЃС‡С‘С‚С‡РёРєР°РјРё РїРѕРїС‹С‚РѕРє Рё РїСЂРѕС…РѕР¶РґРµРЅРёР№.
    """
    try:
        user_id_value = int(user_id)
        level_number_value = int(level_number)
